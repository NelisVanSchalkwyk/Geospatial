...
namespace Measurement
{
    ...
    public static class UnitConverter
    {
        ...
        {
            return KilometersToMeters(MilesToKilometers(miles));
        }
        ...
        {
            return kilometersPerHour * MILES_PER_KILOMETER;
        }
        ...
        {
            return milesPerHour / MILES_PER_KILOMETER;
        }
        ...
        {
            return squareMeter * Math.Pow(1 / 1000, 2);
        }
        ...
        {
            return squareMeter * Math.Pow(FEET_PER_METER, 2);
        }
        ...
        {
            return squareMeter * Math.Pow(MILES_PER_KILOMETER / 1000, 2);
        }
        ...
        {
            return squareKilometer * Math.Pow(1000, 2);
        }
        ...
        /// <param name="squareMeter">The square kilometer area to convert.</param>
        /// <returns>The area in square foot.</returns>
        public static double SquareKilometerToSquareFoot(double squareKilometer)
        {
            return squareKilometer * Math.Pow(FEET_PER_METER * 1000, 2);
        }
        ...
        /// <param name="squareMeter">The square kilometer area to convert.</param>
        /// <returns>The area in square mile.</returns>
        public static double SquareKilometerToSquareMile(double squareKilometer)
        {
            return squareKilometer * Math.Pow(MILES_PER_KILOMETER, 2);
        }
        ...
        {
            return squareFoot * Math.Pow(1 / FEET_PER_METER, 2);
        }
        ...
        /// <param name="squareMeter">The square foot area to convert.</param>
        /// <returns>The area in square kilometer.</returns>
        public static double SquareFootToSquareKilometer(double squareFoot)
        {
            return squareFoot * Math.Pow(1 / FEET_PER_METER / 1000, 2);
        }
        ...
        /// <param name="squareMeter">The square foot area to convert.</param>
        /// <returns>The area in square mile.</returns>
        public static double SquareFootToSquareMile(double squareFoot)
        {
            return squareFoot * Math.Pow(1 / FEET_PER_MILE, 2);
        }
        ...
        {
            return squareMile * Math.Pow(1 / MILES_PER_KILOMETER, 2);
        }
        ...
        /// <param name="squareMeter">The square mile area to convert.</param>
        /// <returns>The area in square kilometer.</returns>
        public static double SquareMileToSquareKilometer(double squareMile)
        {
            return squareMile * Math.Pow(MILES_PER_KILOMETER, 2);
        }
        ...
        /// <param name="squareMeter">The square mile area to convert.</param>
        /// <returns>The area in square foot.</returns>
        public static double SquareMileToSquareFoot(double squareMile)
        {
            return squareMile * Math.Pow(FEET_PER_MILE, 2);
        }
